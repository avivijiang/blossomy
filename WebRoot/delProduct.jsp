	...
	<div class="rightbar">
			...
			<table align="left"
				...
				<tr>
					<td align="left">
                            ...
                            <form class="form-inline" name="form2" action="" method="post"
								role="form" style="width:200px">
								<div class="form-group has-success has-feedback"
									style="width:200px">
									<label class="control-label" for="inputSuccess4">产品查询    </label>
									<input type="text" name="proname" class="form-control"
										id="inputSuccess4"
										value="<%=productName != null ? productName : ""%>" /> <span
		...
		<div class="panel panel-default"
			...
			<div class="panel-body">
				...
				<table width=60% style="position:absolute;left:250px">
						...
						<td>
							<form name="form1" action="" method="post">
								<table class="table table-striped"
									...
									<tr align="center">
										<td width=10%><input type="checkbox" name="ids"
											value="<%=map.get("proid")%>" />
										</td>
