...
// 获取查询的关键词  
String procategory = (String) request.getAttribute("procategory");  
if(list==null){  
	...
	<div class="row" > -->
		...
		<tr>
			<td colspan="4" align="center">共<%=dividePage.getPageCount()%>页
				<a href="javascript:first();">首页</a> <a href="javascript:forward();">上一页</a>
				<a href="javascript:next();">下一页</a> <a href="javascript:end();">尾页</a>
