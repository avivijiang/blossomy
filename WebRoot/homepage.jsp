...
<script type="text/javascript">  
    function searchProduct(){  
        ...
        th.action="<%=path%>/servlet/HomePageAction?action_flag=search";  
        th.submit();  
    }  
      
    function first(){  
          
        window.location.href = "<%=path%>/servlet/HomePageAction?action_flag=search&pageNum=1";  
          
    }  
    function next(){  
          
        window.location.href = "<%=path%>/servlet/HomePageAction?action_flag=search&pageNum=<%=dividePage.getCurrentPage()+1%>";       
    ...
    function end(){  
        ...
        window.location.href = "<%=path%>/servlet/HomePageAction?action_flag=search&pageNum=<%=dividePage.getPageCount()%>";  
              
    }  
      
    function changePage(currentPage){  
      
        window.location.href = "<%=path%>/servlet/HomePageAction?action_flag=search&pageNum="+currentPage;  
    ...
    function del(){  
        ...
        th.action="<%=path%>/servlet/HomePageAction?action_flag=del";  
        th.submit();          
    ...
    function view(){  
        ...
        var th = document.form1;  
        th.action="<%=path%>/servlet/HomePageAction?action_flag=view&proid="+getSelectedValue();  
        th.submit();          
...
<body>
	...
	<div class="sidebar"
		...
		<ul class="animate">
			...
			<li class="animate"
				onclick="javascript:location.href='http://localhost:8080/blossomyAdminSystem/servlet/ProductAction?action_flag=addPage'">上新类别<i
				class="fa fa-plus float-right"></i>
			</li>
       </ul>
		</dropdown>
...
<div class="panel panel-default"
			...
			<div class="panel-heading" style="height:50px">热门推荐</div>
