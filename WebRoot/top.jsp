...
window.onload= function(){
 ...
 th.action = "<%=path%>/servlet/userLoginAction";
    ...
    if(th.pswd.value!=th.comfirmpswd.value)
    {
   alert("两次密码不一致");
   th.pswd.focus();
   return;
	...
	<div id="blossomylogo">
		...
		<div class="bg-div">
			...
			<form class="form-inline" name="searchform" method="post" role="form">
				<input type="text" placeholder="   玫瑰"   name="proname"  class="search-input-text-my"
					value="<%=productName != null ? productName : ""%>" /> <button
					type="submit"  class="search-input-button" 
					onclick="searchProduct()" >搜索</button>
			</form> 
		</div>
	</div>
	<div class="shopcar">
	...
	<div class="container">
		...
		<div class="navbar-collapse collapse" style="height:40px">
			<ul class="nav navbar-nav mynav">
				...
				<li class=""><a href="display2.jsp">永生花</a>
				</li>
				<li class=""><a href="display3.jsp">礼盒</a>
				</li>
				<li class=""><a href="display4.jsp">生日推荐</a>
				</li>
			...
			<div class="register register_pass" style="height:650px">
				...
				<div class="register_nav">
					<img  src="http://www.roseonly.com.cn/upload/syspic_new/14682248238795325.png"
						...
						<input type="password" name="pswd" placeholder="请输入密码" id="pswd" maxlength="16" class="register_password" required>
					<div class="reminder validate"></div>
				</div>
				<div class="register_nav">
